...
export const MOLD_PRESETS: PresetMoldType[] = [
  {
    ...
    params: [
      ...
      // —— 双色模结构系数：value 是加价比例 ——
      { code: 'twoColorCoef', name: '双色模系数', value: '0', unit: '', group: '计价单价', type: 'select', scope: 'mold',
        options: TWO_COLOR_OPTIONS },
      // 钢材三件套属于「一套模具自己的事」——作用域放在模具，跟着每套模具走
      { code: 'materialPrice', name: '钢材单价', value: 25, unit: '元/kg', group: '计价单价', scope: 'mold', materialCode: 'P20' },
      { code: 'steelDensity', name: '钢材密度', value: 7.85, unit: 'g/cm³', group: '计价单价', scope: 'mold' },
      { code: 'steelLossRate', name: '钢材损耗率', value: 0.1, unit: '', group: '计价单价', scope: 'mold' },
      { code: 'materialUnitPrice', name: '原料单价', value: 12, unit: '元/kg', group: '计价单价', scope: 'injection', materialCode: 'ABS' },
      // 原料损耗率：选了材料库材料时用该牌号的损耗率，未选则用这里的值（默认与旧固定值一致）
      { code: 'materialLossRate', name: '原料损耗率', value: 0.05, unit: '', group: '计价单价', scope: 'injection' },
      { code: 'injectionQty', name: '注塑数量', value: 5000, unit: '件', group: '商务', scope: 'injection' },
      // 机台费 = 机台时薪 × 成型周期 ÷ 3600 ÷ 腔数（单件成本）
      { code: 'machineHourlyRate', name: '机台时薪', value: 130, unit: '元/小时', group: '计价单价', scope: 'injection' },
      ...
      { code: 'freightRate', name: '运费单价', value: 1.2, unit: '元/kg', group: '计价单价', scope: 'common' },
      {
  ...
  },
  {
    ...
    params: [
      ...
      { code: 'polishHours', name: '抛光工时', value: 0, unit: '小时', group: '模具', scope: 'mold' },
      // 压铸模芯用热作钢，默认价跟 H13 走
      { code: 'steelPrice', name: '钢材单价', value: 45, unit: '元/kg', group: '计价单价', scope: 'common', materialCode: 'H13' },
      { code: 'steelDensity', name: '钢材密度', value: 7.85, unit: 'g/cm³', group: '计价单价', scope: 'common' },
      { code: 'steelLossRate', name: '钢材损耗率', value: 0.12, unit: '', group: '计价单价', scope: 'common' },
      { code: 'alloyPrice', name: '合金单价', value: 22, unit: '元/kg', group: '计价单价', scope: 'injection', materialCode: 'ADC12' },
      { code: 'alloyLossRate', name: '合金损耗率', value: 0.08, unit: '', group: '计价单价', scope: 'injection' },
      { code: 'machineHourlyRate', name: '机台时薪', value: 150, unit: '元/小时', group: '计价单价', scope: 'injection' },
  ...
  },
  {
    ...
    params: [
      ...
      { code: 'steelPrice', name: '钢材单价', value: 32, unit: '元/kg', group: '计价单价', scope: 'common', materialCode: '718H' },
      { code: 'steelDensity', name: '钢材密度', value: 7.85, unit: 'g/cm³', group: '计价单价', scope: 'common' },
      { code: 'steelLossRate', name: '钢材损耗率', value: 0.1, unit: '', group: '计价单价', scope: 'common' },
      { code: 'hardGluePrice', name: '硬胶单价', value: 12, unit: '元/kg', group: '计价单价', scope: 'injection', materialCode: 'ABS-H' },
      { code: 'hardGlueLossRate', name: '硬胶损耗率', value: 0.05, unit: '', group: '计价单价', scope: 'injection' },
      { code: 'softGluePrice', name: '软胶单价', value: 35, unit: '元/kg', group: '计价单价', scope: 'injection', materialCode: 'TPE-S' },
      { code: 'softGlueLossRate', name: '软胶损耗率', value: 0.06, unit: '', group: '计价单价', scope: 'injection' },
      { code: 'machineHourlyRate', name: '机台时薪', value: 180, unit: '元/小时', group: '计价单价', scope: 'injection' },
  ...
  },
  {
    ...
    params: [
      ...
      { code: 'wireCutLength', name: '线切割长度', value: 0, unit: 'mm', group: '模具', scope: 'mold' },
      { code: 'polishHours', name: '抛光工时', value: 0, unit: '小时', group: '模具', scope: 'mold' },
      { code: 'steelPrice', name: '钢材单价', value: 25, unit: '元/kg', group: '计价单价', scope: 'common', materialCode: 'P20' },
      { code: 'steelDensity', name: '钢材密度', value: 7.85, unit: 'g/cm³', group: '计价单价', scope: 'common' },
      { code: 'steelLossRate', name: '钢材损耗率', value: 0.1, unit: '', group: '计价单价', scope: 'common' },
      { code: 'rubberPrice', name: '橡胶单价', value: 45, unit: '元/kg', group: '计价单价', scope: 'injection', materialCode: 'SILICONE-R' },
      { code: 'rubberLossRate', name: '橡胶损耗率', value: 0.08, unit: '', group: '计价单价', scope: 'injection' },
      { code: 'vulcanizeQty', name: '硫化数量', value: 80000, unit: '件', group: '商务', scope: 'injection' },
      { code: 'machineHourlyRate', name: '机台时薪', value: 90, unit: '元/小时', group: '计价单价', scope: 'injection' },
